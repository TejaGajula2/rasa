            ...
            <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
              ...
              <div className="hidden mx-auto sm:block sm:ml-6">
                <div className="flex space-x-4">
                  <a
                    href="/home"
                    className={` px-3 py-2 rounded-md text-sm font-medium transition duration-500 ease-in-out transform hover:-translate-y-2 ${location=='/home'?"pr-red-bg text-white":"pr-dblu-cg"} `}
                    aria-current="page"
                  >
                    Home
                  </a>
                  ...
                  <a
                    href="/chat"
                    className="pr-dblu-cg hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition duration-500 ease-in-out transform hover:-translate-y-2"
                  >
                    Chats
                  </a>
                </div>
